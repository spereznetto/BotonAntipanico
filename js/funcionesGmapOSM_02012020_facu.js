...
//$('#modalDetallePosicion').modal('show');
    ...
    var pos = $.getJSON(url, function (datos) {
        ...
        drawChart(datos.velocidad, datos.bateria, datos.combustible, 0, datos.equipoFrio, datos.sensorTemp);
    }).done(function () {
        $("#cargandoDatosPosicion").hide();
...
google.charts.setOnLoadCallback(function () {
    drawChart(velocidad, bateria, combustible, temperatura, equipofrio, sensortemp);
});

function drawChart(velocidad, bateria, combustible, temperatura, equipofrio, sensortemp) {
...
function cambiarLayer() {
    ...
    var traffic = new L.tileLayer('//{s}.traffic.maps.cit.api.here.com/maptile/2.1/traffictile/newest/normal.day/{z}/{x}/{y}/256/png8?app_id=' + appID + '&app_code=' + appCODE, {
    ...
    var satelite2 = new L.tileLayer('//{s}.aerial.maps.cit.api.here.com/maptile/2.1/maptile/newest/hybrid.day/{z}/{x}/{y}/256/png8?app_id=' + appID + '&app_code=' + appCODE, {
        attribution: 'Map &copy; 1987-2016 <a href="http://developer.here.com">HERE</a>',
        maxZoom: 17,
        minZoom: 2,
        subdomains: '1234'
