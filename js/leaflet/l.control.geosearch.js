...
L.Control.GeoSearch = L.Control.extend({
  ...
  _config: {
    ...
    notFoundMessage: 'Esa dirección no pudo ser encontrada.',
  ...
  onAdd: function (map) {
    ...
    if (!topCenter) {
      ...
      tc.className += 'leaflet-bottom leaflet-customcenter';
  ...
  _showLocation: function (location) {
    if (this.options.showMarker == true) {
      if (typeof this._positionMarker === 'undefined') {
        ...
        if (typeof this._positionMarker !== 'undefined' && this._positionMarker !== null)
